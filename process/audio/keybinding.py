...
from process.mode.labels import (
    LBL_VIEW_FRONT, LBL_VIEW_BACK, LBL_VIEW_TOP, LBL_VIEW_SIDE,
...
def register_audio_keys(
    ...
    plotter.add_key_event(KEY_ACTOR_NEXT, _tab_cycle)
    ...
    dispatch_key(
        plotter._special_key_dispatch, KEY_VIEW_SIDE,
        lambda: _apply_view((1, 0, 0), (0, 1, 0), LBL_VIEW_SIDE),
    )
