...
FLIP_OBJECT_X   = False   # True -> rotate 180 deg around X -> flips Y, Z signs
FLIP_OBJECT_Y   = False   # True -> rotate 180 deg around Y -> flips X, Z signs
FLIP_OBJECT_Z   = False   # True -> rotate 180 deg around Z -> flips X, Y signs
STARTUP_CAM_DEGREE      = -70
STARTUP_CAM_POSITION    = None   # (truck_dx, pedestal_dy, dolly_dz)
STARTUP_FOCAL_LENGTH    = None   # FOCAL_LENGTH
STARTUP_ZOOM            = None
